...
The leg GRU was tested separately on
`vbhavanantha/g1-leg-gru-benchmark-test`. It is not part of this primary branch
because the primary leg model remains lag10 SysID.
...
- fresh arm and leg plots were generated from the current outputs
